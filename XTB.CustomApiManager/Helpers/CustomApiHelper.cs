...
namespace XTB.CustomApiManager.Helpers
{
    public static class CustomApiHelper
    {
        ...
        public static EntityCollection GetCustomApisOnPremFor(this IOrganizationService service, Guid solutionid)
        {
            var fetchXml = $@"
            <fetch>
              <entity name='customapi'>
        ...
        // ON prem as a slightly different schema (workflowsdkstepenabled is not a column)
        public static EntityCollection GetAllCustomApisOnPrem(this IOrganizationService service)
        {
            var fetchXml = $@"
            <fetch>
              <entity name='customapi'>
